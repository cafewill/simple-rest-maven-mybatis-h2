package com.cube.simple.controller.owner;
...
import com.cube.simple.service.owner.PlaceService;
...
@Slf4j
@RestController("ownerPlaceController")
...
public class PlaceController {
    ...
    public ResponseEntity<?> updateById(@PathVariable Long id, @RequestBody CommonRequest <Place> request) {
        ...
        try {
            ...
            Place found = placeService.selectById(id);
